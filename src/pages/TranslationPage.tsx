...
const TranslationPage = ({ theme, onToggleTheme, username, onLogout }: TranslationPageProps) => {
  ...
  const handleTranslate = () => {
    ...
    // Simulate API — replace with actual Django backend call
    setTimeout(() => {
      const langTranslations = DEMO_TRANSLATIONS[language] || {};
      const translated = langTranslations[text.trim()] || `[${language}] ${text.trim()}`;
